...
class EditAddressPage extends StatefulWidget {
  ...
  const EditAddressPage({Key key, this.address}) : super(key: key);
...
class _EditAddressPageState extends State<EditAddressPage> {
  ...
  void initState() {
    ...
    doorNoController.text = widget.address.doorNo;
    laneController.text = widget.address.lane ?? "";
    streetNameController.text = widget.address.stateName;
    cityNameController.text = widget.address.cityName;
    stateNameController.text = widget.address.stateName;
    landmarkController.text = widget.address.landmark ?? "";
    nameController.text = widget.address.name;
    phoneNumberController.text = widget.address.phoneNumber.toString();
    alternatePhoneNumberController.text = widget.address.alternatePhoneNumber != null
        ? widget.address.alternatePhoneNumber.toString()
        : "";
  }
              ...
              function: () {
                ...
                checkIfValid(address)
                    ? BlocProvider.of<AddressesBloc>(context)
                        .add(UpdateAddress(address: address))
                    : showCustomPopUp("Please enter all the required fields");
              },
            ),
            body: Padding(
